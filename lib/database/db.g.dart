          ...
          $mrjc(
              ...
              $mrjc(
                  ...
                  $mrjc(
                      spa.hashCode,
                      $mrjc(spd.hashCode,
                          $mrjc(spe.hashCode, bst.hashCode))))))));
  @override
  bool operator ==(dynamic other) =>
      identical(this, other) ||
      (other is Stat &&
...
class $StatsTable extends Stats with TableInfo<$StatsTable, Stat> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [nameId, hp, atk, def, spa, spd, spe, bst];
  @override
...
class Move extends DataClass implements Insertable<Move> {
  ...
  factory Move.fromData(Map<String, dynamic> data, GeneratedDatabase db,
    ...
    return Move(
      ...
      basePower: intType
          .mapFromDatabaseResponse(data['${effectivePrefix}base_power'])!,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['base_power'] = Variable<int>(basePower);
...
class MovesCompanion extends UpdateCompanion<Move> {
  ...
  static Insertable<Move> custom({
    ...
    return RawValuesInsertable({
      ...
      if (basePower != null) 'base_power': basePower,
      if (pp != null) 'pp': pp,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (basePower.present) {
      map['base_power'] = Variable<int>(basePower.value);
    }
    if (pp.present) {
...
class $MovesTable extends Moves with TableInfo<$MovesTable, Move> {
  ...
  VerificationContext validateIntegrity(Insertable<Move> instance,
    ...
    if (data.containsKey('base_power')) {
      context.handle(_basePowerMeta,
          basePower.isAcceptableOrUnknown(data['base_power']!, _basePowerMeta));
    } else if (isInserting) {
...
abstract class _$MyDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [pokemons, stats, abilities, learnSets, moves];
}
